public class MyBST<E extends Comparable<E>> {
    ...
    private int getHighest(BinaryNode<E> node) {
        ...
        int left = node.getLeft() != null ? getHighest(node.getLeft()) : 0;
        int right = node.getRight() != null ? getHighest(node.getRight()) : 0;
    ...
    public boolean contains(E value) {
        ...
        while (currNode != null) {
            int cmp = value.compareTo(currNode.getValue());
            if (cmp == 0)
                return true;
            currNode = cmp < 0 ? currNode.getLeft() : currNode.getRight();
        }
        return false;
    }
    ...
    public boolean add(E value) {
        ...
        if (contains(value))
            return false;
        BinaryNode<E> currNode = root, lastNode = root;
        while (currNode != null) {
            lastNode = currNode;
            currNode = value.compareTo(currNode.getValue()) < 0 ? currNode.getLeft() : currNode.getRight();
        }
    ...
    public boolean remove(E value) {
        ...
        BinaryNode<E> currNode = root, childNode = null, replacementNode = null;
        while (currNode != null) {
    ...
    private void addNodes(BinaryNode<E> value) {
        ...
        while (currNode != null) {
            lastNode = currNode;
            currNode = value.getValue().compareTo(currNode.getValue()) < 0 ? currNode.getLeft() : currNode.getRight();
        }
