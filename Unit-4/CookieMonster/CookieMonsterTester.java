...
public class CookieMonsterTester {
	...
	public static void main(String[] args) {
		...
		for (String fileName : fileNames) {
			...
			System.out.println("Optimal path has " + optqueue + " cookies, using a queue to search.  TIME: "
					+ (end2 - end1) + " milliseconds");
			int optstack = monster.stackCookies();
			long end3 = System.currentTimeMillis();
			System.out.println("Solved using stack");
			System.out.println("Optimal path has " + optstack + " cookies, using a stack to search.  TIME: "
